...
```
You can create an API Token via the Service Credentials section of F5 XC. Refer to the following for instructions https://docs.cloud.f5.com/docs-v2/administration/how-tos/user-mgmt/Credentials#service-credentials
